...
import Ketentuan from "../assets/images/Maxim/ketentuan.png"
        ...
        <Wrapper>
            ...
            <section id="section-2" className="relative flex flex-col bg-[#FEF0C7] min-h-full">
                <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Sore itu pada sebuah kesempatan di penghujung 2023, Bayu (27) sedang asyik mengobrol dengan rekan sejawatnya di sebuah tempat yang berada di daerah Ciputat, Tangerang Selatan. Bangunan di mana tempat Bayu bersama teman-temannya bercengkrama itu tidak terlalu besar, tidak juga terlalu sempit, dapat dikatakan tempat tersebut merupakan <i>basecamp</i> untuk Bayu bersama rekan sesama pengemudi ojek <i>online</i> lainnya untuk berkumpul bersama.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Pria yang merantau ke Jabodetabek pada masa Covid itu mengaku sudah melakoni pekerjaan sebagai ojek <i>online</i> sejak tiga tahun lalu. Harapannya untuk mendapatkan pekerjaan di kota, rupanya tak seperti yang dia bayangkan. Apalagi saat dia mulai menapakkan kaki di Kawasan Jabodetabek, pandemi Covid-19 datang menyergap. Jadilah dia terlunta-lunta tanpa harapan yang pasti.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Situasi terburuk justru Bayu lewati ketika Pembatasan Sosial Berskala Besar (PSBB) diberlakukan terkait situasi pandemi. Kala itu, tahun 2020, pemerintah sempat melarang pengemudi ojek <i>online</i> mengangkut penumpang. Praktis, pendapatan Bayu pun melorot drastis.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Semasa Covid, penumpang sepi. Tentu beda banget jika dibanding sebelum ada pembatasan sosial,” ujar pengemudi Maxim itu menjelaskan. </motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Mungkin beberapa di antara Anda masih jarang mengetahui keberadaan Maxim, atau bahkan sama sekali tidak mengetahuinya. Maxim merupakan sebuah  perusahaan berbasis aplikasi digital asal Rusia yang mulai beroperasi di Indonesia sejak 2019. Dikenal dengan ciri khas atribut pengemudinya yang serba berwarna kuning, perusahaan ini hampir sama seperti Gojek maupun Grab. Ketiganya menyediakan jasa layanan transportasi <i>online</i>.</motion.p>
                    ...
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Sumber penghasilan para pengemudi ojol ditentukan berdasarkan pesanan yang diterima dan jarak yang ditempuh dalam proses pengantaran. Hal ini diatur melalui keputusan Menteri Perhubungan Nomor KP 1001 Tahun 2022 tentang Pedoman Perhitungan Biaya Jasa Penggunaan Sepeda Motor yang Digunakan untuk Kepentingan Masyarakat yang Dilakukan dengan Aplikasi. Pada dasarnya, perusahaan aplikasi mengenakan biaya tidak langsung dengan batasan maksimal 15% dari biaya sewa untuk penggunaan aplikasi tersebut.</motion.p>
                    ...
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Selain itu, penghasilan juga dipengaruhi oleh apakah pesanan diterima pada jam sibuk. Bayu menerangkan bahwa aplikator (dalam konteks ini pihak Maxim) menerapkan sistem bagi hasil dengan memotong sekitar 10-15%. “Kalau untuk Maxim sendiri saat ini kisarannya ada di angka 10-15%, minimal itu potongan 10%, maksimal itu 15%, sesuai dengan anjuran pemerintah,” ujarnya.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Aplikator  akan memotong penghasilan pengemudi ojol  sebesar 15% dari total ongkos kirim. Sebagai contoh, pengemudi Maxim mendapatkan penumpang dengan ongkos pengantaran yang tertera di aplikasi sebesar Rp30.000 maka perhitungannya adalah Rp 30.000 - (30.000 x 15%) = Rp 25.500. Angka Rp25.500 itulah yang akan menjadi pendapatan sang pengemudi ojol dan yang Rp4.500 akan masuk ke kantong pihak Maxim.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Usut punya usut, ternyata potongan biaya dalam aplikasi ini sebelumnya hampir dikeluhkan semua pengemudi ojek <i>online</i> lantaran jumlahnya yang cukup besar, yakni mencapai angka 20%.  Aplikator menerapkan hal itu dengan berpijak pada  Keputusan Menteri Perhubungan Republik Indonesia Nomor KP 564 Tahun 2022 Tentang &quot;Pedoman Perhitungan Biaya Jasa Penggunaan Sepeda Motor yang Digunakan untuk Kepentingan Masyarakat Yang Dilakukan Dengan Aplikasi&quot; yang kini statusnya telah dicabut dan diganti dengan  Keputusan Menteri Perhubungan Nomor 667 Tahun 2022 dan keputusan Menteri Perhubungan Nomor KP 1001 Tahun 2022.</motion.p>
            ...
            <section id="section-3" className="relative flex bg-cream-primary min-h-full justify-center items-center">
                <div className="relative mx-10 md:mt-10 md:mb-[800px] md:mx-44 text-justify text-md mt-10">
                    ...
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Pekerjaan sebagai pengemudi ojek <i>online</i> yang berstatus sebagai” mitra”, membuat para <i>driver</i> cenderung tereksploitasi oleh aplikator. Pasalnya, di negeri ini,  belum ada payung hukum yang jelas mengenai transportasi ojek <i>online</i>.</motion.p>
                    ...
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kita nggak ada ketentuan jam kerja karena statusnya mitra. Nah, kemarin kan juga sempat yang mau ada pengaturan jam kerja dari Kemnaker, itu kita sempat tolak, kalau kita mau dibatasi jam kerja, harusnya ada hak-hak dan kewajiban yang tegak lurus lah sama hal yang akan diberlakukan,” tegasnya.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Pada Agustus 2023, Kementerian Ketenagakerja sempat memiliki wacana untuk mengatur jam kerja ojol menjadi 10 jam per hari nya. Namun, banyak pengemudi ojek <i>online</i> yang keberatan lantaran mereka menganggap pendapatan akan berkurang jika jam kerja akan dibatasi menjadi 10 jam.</motion.p>
            ...
            <section id="section-2">
                <div className="relative flex flex-col min-h-full bg-[#FEF0C7]">
                    ...
                    <motion.div variants={zoomOutAnimation} viewport={{ once: true }} initial="hidden" whileInView="visible" className="relative z-10 p-10 text-justify rounded-xl mx-6 mt-16 mb-20 md:p-10 md:mb-96 md:-mt-[600px] md:rounded-3xl md:mx-44 bg-white">
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kita audiensi mengenai keresahan kita, tetapi hanya ditampung-tampung saja tanpa ada kejelasan, tanpa ada <i>feedback</i> seperti apa ke depannya,” keluh Bayu.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Balik lagi ke masalah payung hukum ojol itu belum ada di Indonesia, jadi seolah-olah aplikator itu masih semaunya ke kita yang sifatnya hanya mitra,” lanjutnya menjelaskan ketidakpuasan yang dirasakan.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Sejak tahun 2018 hingga 2023, Indonesia menyaksikan gelombang demonstrasi yang melibatkan sejumlah besar pengemudi ojek <i>online</i>. Protes ini tidak hanya mencerminkan ketidakpuasan, tetapi juga merupakan ekspresi dari berbagai isu yang melibatkan para pekerja <i>platform</i> digital ini.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Sepanjang aksi demo tersebut para pengemudi menyampaikan beberapa tuntutan, di antaranya perihal meminta aplikator untuk memenuhi janjinya, menolak keras status aplikator sebagai perusahaan transportasi,  menentang dengan tegas eksploitasi terhadap pengemudi ojol, menolak dengan keras adanya monopoli dalam bisnis transportasi <i>online</i> dan terakhir, tuntutan bahwa jika aplikator tidak memenuhi tuntutan yang diajukan, mereka akan meminta kepada pemerintah untuk mengusir Grab dan Gojek dari Indonesia serta membuat aplikasi pemerintah sebagai alternatif.</motion.p>
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Mengapa kami melakukan demo? Ya karena itu tadi, masalah seperti tidak adanya keterbukaan, argo minim, dan jumlah potongan yang besar,” ujarnya.</motion.p>
