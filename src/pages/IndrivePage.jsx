            ...
            <section id="section-2">
                <motion.div variants={fadeUpSection3} viewport={{ once: true }} initial="hidden" whileInView="visible" className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“12 persen,” jawab Bagus (21), yang juga merupakan pengemudi InDrive.</motion.p>
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kita kan dibudakin aplikator,” Ujar Budi tiba-tiba.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kalau ada demo biasanya bukan cuman InDrive aja, tapi banyak juga ojol dari berbagai aplikasi yang ikut, tujuan kita demo buat minta kesejahteraan ”ujar  Budi ketika ditanya perihal aksi demo yang kerap kali dilakukan oleh pengemudi ojol.</motion.p>
