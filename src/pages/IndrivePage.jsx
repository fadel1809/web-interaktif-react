        ...
        <Wrapper>
            ...
            <section id="section-2" className="relative flex flex-col bg-bg-indrive min-h-full z-0">
                <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                    ...
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Bedanya Indrive sama aplikasi lain itu para customernya bisa nawar harga,” ujar Junaidi (33), pengemudi ojek <i>online</i> yang sudah bergabung di InDrive selama kurang lebih 2, 5 tahun.</motion.p>
            ...
            <section id="section-2">
                <motion.div variants={fadeUpSection3} viewport={{ once: true }} initial="hidden" whileInView="visible" className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“12 persen,” jawab pengemudi indrive inisial B yang tidak ingin disebutkan namanya itu</motion.p>
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kita kan dibudakin aplikator,” Jawab pengemudi indrive inisial B yang tidak ingin disebutkan namanya itu.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kalau ada demo biasanya bukan cuman InDrive aja, tapi banyak juga ojol dari berbagai aplikasi yang ikut, tujuan kita demo buat minta kesejahteraan”  lanjutnya ketika ditanya perihal aksi demo yang kerap kali dilakukan oleh pengemudi ojol</motion.p>
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Sebenarnya, untuk jadi karyawan tetap semua ojol pasti pengen ya, tapi kan mustahil. Paling nggak potongannya aja sih yang agak direndahin, ya sedikit aja lah ngga usah banyak-banyak,” kata Junaidi.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Ada banyak penelitian menyajikan argumen tentang dampak negatif dari kemitraan yang tidak seimbang terhadap pekerja. Bahkan, ada pandangan bahwa gagasan kemitraan yang digaungkan oleh ekonomi gig sebenarnya merupakan bentuk lain dari memperlakukan pekerja sebagai ‘barang dagangan’ belaka. Hal ini bisa berpotensi menyebabkan eksploitasi.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kalau dibilang merasa (ekploitasi) ya merasa, cuman kan di satu sisi kita butuh, buat kebutuhan sehari-hari, kalau kita ngga gitu (kerja) kita nyari cuannya dari mana?  Mau ngga mau ya ikutin aja,” ujar Junaidi terlihat pasrah.</motion.p>
