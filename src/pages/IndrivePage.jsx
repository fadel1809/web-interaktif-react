...
import Asset2 from "../assets/images/inDrive/asset-3.png"
        ...
        <Wrapper>
                ...
                <div className="relative flex-grow bg-green-indrive rounded-2xl my-10 mx-10 md:my-20 md:mx-44">
                    ...
                    <div className="flex flex-col md:flex-row justify-between md:mt-[4rem]">
                        <div className="flex flex-col mt-20 md:mt-24 md:ml-7">
                            ...
                            <p className="flex flex-row text-white items-center font-extrabold mx-auto md:-ml-0 text-2xl md:text-4xl mb-2">Di Balik Cerita Aplikasi </p>
                            <p className="flex flex-row text-white font-extrabold mx-auto text-2xl md:-ml-0 md:text-4xl mb-4">Ojol Asal Rusia</p>
                        </div>
                        <img src={Asset2} className="size-full md:size-7/12"></img>
                    </div>
                </div>
            </section>
            ...
            <section id="section-2" className="relative flex flex-col bg-bg-indrive min-h-full">
                <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                    <img src={Asset1} className="mr-10 size-fit mb-4 md:-mb-0 md:float-start md:size-5/12"></img>
                    <p className="mb-4">Indrive, mungkin beberapa di antara Anda masih asing dengan nama tersebut. Dapat dikatakan, jasa layanan transportasi yang masih baru ini memiliki perbedaan yang paling signifikan dibandingkan dengan pesaingnya, hal ini juga yang menjadi keunggulan bagi aplikasi tersebut. Aplikasi yang semula dikenal dengan sebutan “Indriver” berubah nama menjadi “Indrive” karena perusahaan tersebut telah melakukan rebranding pada 2022 lalu. Indrive juga mengubah identitas atribut para pengemudinya yang serba biru menjadi warna hijau. Lantas, apa bedanya inDrive dengan jasa transportasi lain seperti Gojek, Grab , maupun Maxim?</p>
                    ...
                    <figure className="md:hidden mb-4">
                        <img src={Indrive1} className="rounded-2xl"></img>
                        <figcaption className="text-center text-sm mt-1">Foto: Natia Rizky</figcaption>
                    </figure>
                    <p className="mb-4">“Bedanya Indrive sama aplikasi lain itu para customernya bisa nawar harga,” ujar Junaidi (33), pengemudi ojek online yang sudah bergabung di InDrive selama kurang lebih 2, 5 tahun.</p>
                    <p className="mb-4">Perbedaan dan keunggulan Indrive dibanding dengan aplikasi lain terletak pada fleksibilitas yang ditawarkan, sehingga konsumen dapat memilih berapa biaya yang ingin mereka keluarkan untuk perjalanan mereka.</p>
                    <p className="mb-4">“Ada patokannya minimal berapa, ngga bisa semena mena juga,” jelas Junaidi.</p>
                    <figure className="md:hidden mb-4">
                        <img src={Indrive2} className="rounded-2xl"></img>
                        <figcaption className="text-center text-sm mt-1">Foto: Natia Rizky</figcaption>
                    </figure>
                    <p className="mb-0">Meski begitu, konsumen tidak serta merta menetapkan sendiri tarif sesuai keinginan. Indrive tentu telah menetapkan standar harga, yang kemudian konsumen dapat menawarnya.</p>
            ...
            <section id="section-2">
                <div className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        <p className="mb-4">Walaupun Indrive belum merata di seluruh Indonesia, kini sudah ada beberapa daerah yang telah aktif menggunakan layanan transportasi ini, terutama di wilayah Jabodetabek.</p>
                        <p className="mb-4">Perusahaan asal Rusia yang didirikan pada tahun 2012 ini mulai melakukan ekspansi ke Indonesia pada tahun 2021. Sama seperti pesaingnya, Indrive menerapkan sistem bagi hasil antara perusahaan dengan mitranya. Aplikator memotong 12% dari total penghasilan yang diterima oleh pengemudi. Walaupun potongan ini masih dalam batas aman sesuai dengan peraturan Kementerian Perhubungan, tetapi para pengemudi masih merasa jumlah potongan tersebut terlalu besar dan membebankan mereka.</p>
                        <p className="mb-4">“Berapa sih potongan kita?” Tanya Junaidi ke sesama rekan sesama pengemudi yang sedang duduk di sebelahnya.</p>
                        <p className="mb-4">“11 persen kan ya?,” Lanjutnya.</p>
                        <p className="mb-4">“12 persen,” jawab Bagus (21), yang juga merupakan pengemudi InDrive.</p>
                        <p className="mb-4">“Ohiya 12 persen, untuk tarifnya Rp 2.500 per km, ya standar aja nggak jauh beda sama yang lain sebenarnya,” Junaidi membalas.</p>
                        <p className="mb-4">“Kita kan dibudakin aplikator,” Ujar Budi tiba-tiba.</p>
                        <p className="mb-4">“Kalau ada demo biasanya bukan cuman InDrive aja, tapi banyak juga ojol dari berbagai aplikasi yang ikut, tujuan kita demo buat minta kesejahteraan ”ujar  Budi ketika ditanya perihal aksi demo yang kerap kali dilakukan oleh pengemudi ojol.</p>
                        <p className="mb-4">Memang dalam kurun waktu lima sampai enam tahun terakhir para mitra ojek online dari berbagai aplikasi melakukan aksi demonstrasi, baik pengemudi ojol yang berdomisili di Jabodetabek, maupun luar Jabodetabek. Tuntutan yang seringkali dibahas oleh para pengemudi yakni masalah payung hukum dan perlindungan kepada mereka sebagai status mitra, mereka juga merasa batas potongan sejumlah 20% yang diberikan oleh pemerintah masih terlalu besar dikarenakan mereka menanggung semua biaya bensin, BBM, parkir, pulsa, hingga biaya service motor dan lainnya. Para pengemudi juga meminta pemerintah untuk mempertimbangkan agar status mitra dapat diubah menjadi karyawan tetap.</p>
                        <p className="mb-4">“Sebenarnya, untuk jadi karyawan tetap semua ojol pasti pengen ya, tapi kan mustahil. Paling nggak potongannya aja sih yang agak direndahin, ya sedikit aja lah ngga usah banyak-banyak,” kata Junaidi.</p>
                        <p className="mb-4">Ada banyak penelitian menyajikan argumen tentang dampak negatif dari kemitraan yang tidak seimbang terhadap pekerja. Bahkan, ada pandangan bahwa gagasan kemitraan yang digaungkan oleh ekonomi gig sebenarnya merupakan bentuk lain dari memperlakukan pekerja sebagai ‘barang dagangan’ belaka. Hal ini bisa berpotensi menyebabkan eksploitasi.</p>
                        <p className="mb-4">“Kalau dibilang merasa (ekploitasi) ya merasa, cuman kan di satu sisi kita butuh, buat kebutuhan sehari-hari, kalau kita ngga gitu (kerja) kita nyari cuannya dari mana?  Mau ngga mau ya ikutin aja,” ujar Junaidi terlihat pasrah.</p>
                        <p className="mb-4">Di sisi lain, pekerja gig seperti pengemudi ojek online maupun kurir paket menyebabkan jebakan pekerjaan dengan keterampilan rendah. Jebakan ini terjadi ketika pekerjaan yang ada tidak menuntut pengembangan keterampilan yang dapat meningkatkan peluang kerja atau pendapatan di masa depan bagi individu. Dengan kata lain, pekerja gig terperangkap dalam pekerjaan yang minim kesempatan untuk meningkatkan kualifikasi mereka.</p>
                        <p className="mb-4">Dalam konteks pengemudi ojek online, masalah tersebut semakin diperparah oleh struktur pendidikan dari sebagian besar pengemudi ojol karena sebatas lulusan SMA. Pada periode April- Mei 2023, salah satu Lembaga riset di Indonesia, Institute for Demographic and Poverty Studies (IDEAS), melakukan survey non-probabilitas dengan teknik purposive sampling terhadap 225 pengemudi ojek daring di 10 titik simpul transportasi di Jabodetabek. Hasilnya, data menunjukkan bahwa pendidikan terakhir dari profesi pengemudi ojek online merupakan di tingkat Sekolah Menengah Atas (SMA).</p>
                        <img src={Asset3} className="mb-4"></img>
                        <p className="mb-4">Fakta bahwa  sebagian besar pengemudi memiliki latar belakang pendidikan sekolah menengah (SMA) atau bahkan lebih rendah,menunjukkan bahwa banyak di antara mereka mungkin tidak memiliki akses ke pelatihan lebih lanjut atau pendidikan tinggi yang dapat membuka peluang kerja yang lebih luas.</p>
                        <p className="mb-4">Dalam hal ini, Kementerian Ketenagakerjaan menyediakan sebuah solusi dengan menyediakan aplikasi bernama Siap Kerja untuk masyarakat yang ingin mencari pekerjaan, mendapatkan sertifikat nasional, mengikuti pelatihan, hingga memulai bisnis. Siap Kerja yang diluncurkan pada tahun 2022 itu, dibuat dengan tujuan untuk mempersiapkan mematangkan, dan menyediakan fasilitas kepada masyarakat agar mereka dapat meningkatkan efektivitas dan kemampuan mereka pada bidang ketenagakerjaan. Hal ini juga dibuat karena Kemnaker menyadari bahwa para pekerja gig ekonomi seperti pengemudi ojol, kurir paket, dan profesi lain membutuhkan dukungan agar mereka meningkatkan kapasitas dirinya.</p>
                        <p className="mb-4">Namun, alih-alih menciptakan solusi, naas masih banyak pengemudi ojek online yang tidak mengetahui adanya fasilitas yang disediakan oleh Kemnaker, seperti Siap Kerja yang dihadirkan untuk membantu mereka.</p>
                        <p className="mb-4">“Wah kalau itu saya nggak tahu,” kata Junaidi.</p>
