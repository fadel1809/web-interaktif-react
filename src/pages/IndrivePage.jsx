        ...
        <Wrapper>
            ...
            <section id="section-2" className="relative flex flex-col bg-bg-indrive min-h-full">
                <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                    ...
                    <p className="mb-4">“Bedanya Indrive sama aplikasi lain itu para customernya bisa nawar harga,” ujar Junaidi (33), pengemudi ojek <i>online</i> yang sudah bergabung di InDrive selama kurang lebih 2, 5 tahun.</p>
            ...
            <section id="section-2">
                <div className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        ...
                        <p className="mb-4">Namun, alih-alih menciptakan solusi, naas masih banyak pengemudi ojek <i>online</i> yang tidak mengetahui adanya fasilitas yang disediakan oleh Kemnaker, seperti Siap Kerja yang dihadirkan untuk membantu mereka.</p>
