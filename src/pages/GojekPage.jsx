        ...
        <Wrapper>
            ...
            <section id="section-2">
                <div className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        <p className="mb-4">Masa-masa “emas” itu ketika layanan jasa transportasi <i>online</i> belum lama beroperasi di Indonesia, yakni pada 2015-2017. Kala itu, pekerjaan sebagai pengemudi ojek <i>online</i> dapat dikatakan sebagai primadona dan sedang berada pada puncak popularitasnya dengan penghasilan hingga Rp10 juta per bulan. Pendapatan yang luar biasa ini akhirnya menarik perhatian banyak orang untuk berbondong-bondong menjadi pengemudi ojek <i>online</i>.</p>
                        ...
                        <p className="mb-4">“Maunya kita adalah minta dukungan dari pemerintah, kalau bisa pemerataan nih semua aplikasi tarifnya sama sehingga <i>customer</i> pun bisa memilih mana yang lebih nyaman,” jelasnya.</p>
                    </div>
