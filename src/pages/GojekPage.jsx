        ...
        <Wrapper>
                ...
                <div className="relative flex-grow bg-green-gojek rounded-2xl my-10 mx-10 md:my-20 md:mx-44">
                    ...
                    <div className="flex flex-col md:flex-row justify-between md:mt-[4rem]">
                        <div className="flex flex-col mt-20 md:mt-10 md:mb-12 md:ml-7">
                            ...
                            <motion.p variants={fadeUpParagraphSection1} initial="hidden" animate="visible" className="flex flex-row text-white font-semibold md:font-bold mx-auto md:-ml-0 text-2xl md:text-5xl md:text-nowrap mb-2">Perempuan “Ojol”</motion.p>
                            <motion.p variants={fadeUpParagraphSection1} initial="hidden" animate="visible" className="flex flex-row text-white font-semibold md:font-bold mx-auto md:-ml-0 text-2xl md:text-5xl md:text-nowrap mb-2">Mengenang Masa</motion.p>
                            <motion.p variants={fadeUpParagraphSection1} initial="hidden" animate="visible" className="flex flex-row text-white font-semibold md:font-bold mx-auto md:-ml-0 text-2xl md:text-5xl md:text-nowrap mb-2">Lalu, Nasib Gojek</motion.p>
                            <motion.p variants={fadeUpParagraphSection1} initial="hidden" animate="visible" className="flex flex-row text-white font-semibold md:font-bold mx-auto md:-ml-0 text-2xl md:text-5xl md:text-nowrap mb-2">Tidak Lagi</motion.p>
                            <motion.p variants={fadeUpParagraphSection1} initial="hidden" animate="visible" className="flex flex-row text-white font-semibold md:font-bold mx-auto md:-ml-0 text-2xl md:text-5xl md:text-nowrap mb-2">Seperti Dulu</motion.p>
                        </div>

                        <div className="relative mt-10 w-full md:w-full md:mt-3 md:ml-2">
                            <div className="absolute inset-0 w-fit h-fit">
                                <img src={BackgroundGojek} />
                            </div>
                            <div className="relative z-10 ml-12 mt-[4.3rem] w-7/12 md:mt-28 md:w-[60%] md:ml-20">
            ...
            <section id="section-2" className="relative flex flex-col bg-[#CCE7CB] min-h-full">
                <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Perempuan tak semata-mata dikodratkan untuk berkutat di urusan rumah tangga  semata. Kini, persepsi terhadap peran perempuan di dunia kerja telah berubah secara signifikan. Sudah semakin banyak perempuan di Indonesia yang aktif berkontribusi dalam dunia kerja, membagi keringat dan tenaga dan usaha mereka. Emansipasi perempuan telah jauh meninggalkan stigma bahwa kaum hawa hanya layak berperan dalam urusan mengurusi keluarga.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Meskipun  sebagian kalangan belum sepenuhnya mendukung peran perempuan di dunia kerja, tetapi Indonesia menunjukkan bahwa lapangan kerja semakin terbuka bagi semua gender. Sebutlah misalnya Ines (43). Perempuan ini telah menggeluti pekerjaan sebagai pengemudi ojek <i>online</i> sejak 2015, ketika Gojek mulai hadir di Indonesia.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Sore itu, pada pertemuan di pertengahan November 2023, Ines sedang menyuapi buah hati di sela-sela waktu istirahat bekerja, di sebuah warung makan sederhana. Berada di daerah Kemang Timur, warung makan tersebut juga merupakan <i>basecamp</i>, tempat Ines dan teman-teman sesama pengemudi ojek <i>online</i> lainnya biasa berkumpul.</motion.p>
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Sebagai seorang ibu, mengasuh dua anaknya yang masih balita di samping menjalani pekerjaan sebagai pengemudi ojek <i>online</i> bukanlah hal yang mudah. Ines harus pandai mengatur waktu agar kewajiban sebagai ibu rumah tangga dan pengemudi ojek berjalan seimbang. Itulah sebabnya, Ines tidak terlalu <i>ngoyo</i> mencari nafkah. Sadar akan kodratnya sebagai perempuan, dia tak ingin urusan rumah tangga terbengkalai.</motion.p>
                    ...
                    <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Selama kurang lebih sembilan tahun ia menekuni pekerjaan sebagai pengemudi ojek <i>online</i>, Ines pernah melewati masa keemasan dan masa terpuruk. Masa-masa keemasan tersebut ketika tarif yang ditetapkan oleh aplikator cukup menguntungkan bagi para pengemudi ojol untuk per 1 kilometernya.  Bahkan, tak heran jika para pengemudi ojol bisa mendapatkan hasil di kisaran Rp 6 juta - Rp 10 juta dalam waktu satu bulan.</motion.p>
                </div>
            </section>
            ...
            <section id="section-2">
                <div className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Masa-masa emas itu ketika layanan jasa transportasi <i>online</i> belum lama beroperasi di Indonesia, yakni pada 2015-2017. Kala itu, pekerjaan sebagai pengemudi ojek <i>online</i> dapat dikatakan sebagai masa-masa yang menyenangkan.  Pendapatan yang menembus angka Rp 10 juta cukup menggiurkan sehingga menarik minat banyak orang untuk berbondong-bondong menjadi pengemudi ojek <i>online</i>.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">“Kalau disuruh bilang lebih enak mana sama dulu? Ya, lebih enak dulu-lah,  soalnya kan tarifnya malah Rp 4.000 untuk sekilo” jelas Ines terlihat sumringah menceritakan masa jayanya.</motion.p>
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6">Saat ini, ia hanya bisa merindukan masa lalu itu sebagai kenangan, ditambah lagi bonus yang kecil dan sulit untuk didapatkan, serta potongan yang diberlakukan oleh aplikasi membuat sejumlah mitra ojol  merasa terpuruk, yakni berada di kisaran Rp 1.800 - Rp 2.000,00.</motion.p>
                        ...
                        <motion.p variants={fadeUpParagraph} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mb-6"> “Sekarang tuh banyak layanan transportasi <i>online</i> ya,  untuk saat ini Gojek dan Grab istilahnya udah sama, dia mengikuti pemerintah. Kalau sekarang ini ada Indrive, ada Maxim, nah itu mereka kan tarifnya lebih murah dari kita,” kata Paulina.</motion.p>
