        ...
        <Wrapper>
            ...
            <section id="section-2" className="relative flex flex-col bg-[#CCE7CB] min-h-full">
                <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                    ...
                    <motion.img variants={slideRightImage} viewport={{ once: true }} initial="hidden" whileInView="visible" src={Asset3} className="md:hidden mb-6"></motion.img>
            ...
            <section id="section-2">
                <div className="relative flex flex-col bg-cream-primary min-h-full">
                    <div className="relative mx-10 md:my-20 md:mx-44 text-justify text-md mt-10">
                        ...
                        <motion.img variants={zoomOutAnimation} viewport={{ once: true }} initial="hidden" whileInView="visible" src={Asset3} className="hidden md:block mb-6"></motion.img>
